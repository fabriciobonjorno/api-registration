...
class StatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create state" do
    assert_difference('State.count') do
      post states_url, params: { state: { initials: @state.initials, name: @state.name } }, as: :json
    end
  ...
  test "should update state" do
    patch state_url(@state), params: { state: { initials: @state.initials, name: @state.name } }, as: :json
    assert_response 200
  end
